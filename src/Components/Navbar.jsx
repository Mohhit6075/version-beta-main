    ...
    <>
      <div id="navbar">
        <div
          className={
            isSticky
              ? "fixed w-full mx-auto flex justify-between items-center text-[#ddd] pt-4 bg-[#111] z-50 transition-all duration-200 md:justify-around lg:justify-around xl:justify-around"
              : "static w-full mx-auto flex justify-around items-center text-[#ddd] pt-4 z-10"
          }
        >
